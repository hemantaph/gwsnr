...
noise_weighted_inner_product = njit_functions.noise_weighted_inner_product
...
def noise_weighted_inner_prod(params):
    ...
    for det in list_of_detectors:
        ...
        """
        # might need to add these lines in the future for waveform with multiple harmonics.
