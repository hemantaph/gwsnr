...
#     ra, dec, psi, phase = np.random.uniform(0,2*np.pi, size=nsamples), np.random.uniform(-np.pi/2,np.pi/2, size=nsamples), np.random.uniform(0,2*np.pi, size=nsamples), np.random.uniform(0,2*np.pi, size=nsamples)
